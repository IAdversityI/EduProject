...
! function(a) {
	...
	return function b(a, c, d) {
			...
			var h = a("./clickable-component.js"),
				...
				p = function(a) {
					...
					return g(b, a), b.prototype.createEl = function() {
						...
						}, b), "button" !== a && (m["default"].warn("Creating a Button with an HTML element of " + a + " is deprecated; use ClickableComponent instead."), b = o["default"]({
							tabIndex: 0
						}, b), c = o["default"]({
							role: "button"
						}, c)), c = o["default"]({
			...
			var i = a("./component"),
				...
				w = function(a) {
					function b(c, d) {
						...
						return e.emitTapEvents(), e.on("myTap", e.handleClick), e.on("click", e.handleClick), e.on("focus", e.handleFocus), e.on("blur", e.handleBlur), e
					}
					return h(b, a), b.prototype.createEl = function() {
						...
						c = v["default"]({
							className: this.buildCSSClass(),
							tabIndex: 0
						}, c), "button" === b && r["default"].error("Creating a ClickableComponent with an HTML element of " + b + " is not supported; use a Button instead."), d = v["default"]({
							role: "button",
							"aria-live": "polite"
						}, d);
		...
		5: [function(a, b, c) {
					...
					return a.prototype.dispose = function() {
						...
						this.on("touchleave", f), this.on("touchcancel", f), this.on("touchend", function(c) {
							if(b = null, e === !0) {
								...
								d > f && (c.preventDefault(), this.trigger("myTap"))
							}
						})
			...
			"./utils/guid.js": 84,
			"./utils/log.js": 85,
			"./utils/merge-options.js": 86,
			"./utils/to-title-case.js": 89,
			"global/window": 93
		}],
		6: [function(a, b, c) {
			"use strict";
		...
		8: [function(a, b, c) {
			...
			var h = a("../component.js"),
				i = d(h);
			a("./play-toggle.js"), a("./time-controls/current-time-display.js"), a("./time-controls/duration-display.js"), a("./time-controls/time-divider.js"), a("./time-controls/remaining-time-display.js"), a("./live-display.js"), a("./progress-control/progress-control.js"), a("./fullscreen-toggle.js"), a("./volume-control/volume-control.js"), a("./volume-menu-button.js"), a("./mute-toggle.js"), a("./text-track-controls/chapters-button.js"), a("./text-track-controls/descriptions-button.js"), a("./text-track-controls/subtitles-button.js"), a("./text-track-controls/captions-button.js"), a("./audio-track-controls/audio-track-button.js"), a("./playback-rate-menu/playback-rate-menu-button.js"), a("./spacer-controls/custom-control-spacer.js");
			var j = function(a) {
				function b() {
			...
			"./spacer-controls/custom-control-spacer.js": 21,
			"./text-track-controls/captions-button.js": 24,
			"./text-track-controls/chapters-button.js": 25,
			"./text-track-controls/descriptions-button.js": 27,
			"./text-track-controls/subtitles-button.js": 29,
			"./time-controls/current-time-display.js": 32,
			"./time-controls/duration-display.js": 33,
			"./time-controls/remaining-time-display.js": 34,
			"./time-controls/time-divider.js": 35,
			"./volume-control/volume-control.js": 38,
			"./volume-menu-button.js": 40
		}],
		9: [function(a, b, c) {
			"use strict";
		...
		13: [function(a, b, c) {
			...
			c.__esModule = !0;
			var i = a("../../menu/menu-button.js"),
				j = e(i),
				k = a("../../menu/menu.js"),
				l = e(k),
				m = a("./playback-rate-menu-item.js"),
				n = e(m),
				o = a("../../component.js"),
				p = e(o),
				q = a("../../utils/dom.js"),
			...
			var i = a("../../component.js"),
				...
				m = function(a) {
					function b(c, d) {
						f(this, b);
						var e = g(this, a.call(this, c, d));
						return e.on(c, "progress", e.update), e
					}
					return h(b, a), b.prototype.createEl = function() {
						return a.prototype.createEl.call(this, "div", {
						...
						for(var f = 0; f < a.length; f++) {
							var g = a.start(f),
								h = a.end(f),
								i = d[f];
							i || (i = this.el_.appendChild(l.createEl())), i.style.left = e(g, c), i.style.width = e(h - g, c)
						}
		...
		16: [function(a, b, c) {
			...
			var i = a("global/window"),
				...
				o = a("../../utils/fn.js"),
				p = d(o),
				q = a("../../utils/format-time.js"),
				r = e(q),
				s = a("lodash-compat/function/throttle"),
				t = e(s),
				u = function(a) {
					function b(c, d) {
						f(this, b);
						var e = g(this, a.call(this, c, d));
						return d.playerOptions && d.playerOptions.controlBar && d.playerOptions.controlBar.progressControl && d.playerOptions.controlBar.progressControl.keepTooltipsInside && (e.keepTooltipsInside = d.playerOptions.controlBar.progressControl.keepTooltipsInside), e.keepTooltipsInside && (e.tooltip = n.createEl("div", {
							className: "vjs-time-tooltip"
						}), e.el().appendChild(e.tooltip), e.addClass("vjs-keep-tooltips-inside")), e.update(0, 0), c.on("ready", function() {
							e.on(c.controlBar.progressControl.el(), "mousemove", t["default"](p.bind(e, e.handleMouseMove), 25))
						}), e
					}
					return h(b, a), b.prototype.createEl = function() {
						return a.prototype.createEl.call(this, "div", {
						...
						var b = this.player_.duration(),
							...
							d = a.pageX - n.findElPosition(this.el().parentNode).left;
						this.update(c, d)
					}, b.prototype.update = function(a, b) {
						var c = r["default"](a, this.player_.duration());
						if(this.el().style.left = b + "px", this.el().setAttribute("data-current-time", c), this.keepTooltipsInside) {
							var d = this.clampPosition_(b),
								e = b - d + 1,
								f = parseFloat(j["default"].getComputedStyle(this.tooltip).width),
								g = f / 2;
							this.tooltip.innerHTML = c, this.tooltip.style.right = "-" + (g - e) + "px"
						}
					}, b.prototype.calculateDistance = function(a) {
						return n.getPointerPosition(this.el().parentNode, a).x
					}, b.prototype.clampPosition_ = function(a) {
						if(!this.keepTooltipsInside) return a;
						var b = parseFloat(j["default"].getComputedStyle(this.player().el()).width),
							c = parseFloat(j["default"].getComputedStyle(this.tooltip).width),
							d = c / 2,
							e = a;
						return d > a ? e = Math.ceil(d) : a > b - d && (e = Math.floor(b - d)), e
					}, b
				}(l["default"]);
			l["default"].registerComponent("MouseTimeDisplay", u), c["default"] = u
		}, {
			"../../component.js": 5,
			"../../utils/dom.js": 80,
			"../../utils/fn.js": 82,
			"../../utils/format-time.js": 83,
			"global/window": 93,
			"lodash-compat/function/throttle": 98
		}],
		17: [function(a, b, c) {
			"use strict";
		...
		18: [function(a, b, c) {
			...
			var h = a("../../component.js"),
				i = d(h);
			a("./seek-bar.js"), a("./mouse-time-display.js");
			var j = function(a) {
				function b() {
					return e(this, b), f(this, a.apply(this, arguments))
				}
		...
		19: [function(a, b, c) {
			...
			var i = a("global/window"),
				...
				q = a("../../utils/format-time.js"),
				r = e(q);
			a("./load-progress-bar.js"), a("./play-progress-bar.js"), a("./tooltip-progress-bar.js");
			var s = function(a) {
				function b(c, d) {
					f(this, b);
					var e = g(this, a.call(this, c, d));
				...
				return h(b, a), b.prototype.createEl = function() {
					...
					if(this.updateAriaAttributes(this.el_), this.keepTooltipsInside) {
						...
						var a = parseFloat(j["default"].getComputedStyle(this.player().el()).width),
							b = parseFloat(j["default"].getComputedStyle(this.tooltipProgressBar.tooltip).width),
					...
					a.setAttribute("aria-valuenow", (100 * this.getPercent()).toFixed(2)), a.setAttribute("aria-valuetext", r["default"](b, this.player_.duration()))
			...
			}, s.prototype.playerEvent = "timeupdate", n["default"].registerComponent("SeekBar", s), c["default"] = s
		}, {
			"../../component.js": 5,
			"../../slider/slider.js": 57,
			"../../utils/fn.js": 82,
		...
		23: [function(a, b, c) {
			...
			c.__esModule = !0;
			var h = a("./text-track-menu-item.js"),
				i = d(h),
				j = a("../../component.js"),
				k = d(j),
				l = function(a) {
		...
		24: [function(a, b, c) {
			...
			var h = a("./text-track-button.js"),
				...
				j = a("../../component.js"),
				k = d(j),
				l = a("./caption-settings-menu-item.js"),
				m = d(l),
				n = function(a) {
					function b(c, d, g) {
						e(this, b);
			...
			"../../component.js": 5,
			"./caption-settings-menu-item.js": 23,
			"./text-track-button.js": 30
		}],
		25: [function(a, b, c) {
			"use strict";
			...
			c.__esModule = !0;
			var i = a("./text-track-button.js"),
				j = e(i),
				k = a("../../component.js"),
				l = e(k),
				m = a("./text-track-menu-item.js"),
				n = e(m),
				o = a("./chapters-track-menu-item.js"),
				p = e(o),
				q = a("../../menu/menu.js"),
				r = e(q),
				s = a("../../utils/dom.js"),
				t = d(s),
				u = a("../../utils/to-title-case.js"),
				v = e(u),
				w = function(a) {
					function b(c, d, e) {
						f(this, b);
			...
			"../../utils/dom.js": 80,
			"../../utils/to-title-case.js": 89,
			"./chapters-track-menu-item.js": 26,
			"./text-track-button.js": 30,
			"./text-track-menu-item.js": 31
		}],
		26: [function(a, b, c) {
		...
		27: [function(a, b, c) {
			...
			var i = a("./text-track-button.js"),
				...
				o = function(a) {
					...
					return h(b, a), b.prototype.handleTracksChange = function() {
		...
		30: [function(a, b, c) {
			...
			var h = a("../track-button.js"),
				...
				m = d(l),
				n = a("./off-text-track-menu-item.js"),
				o = d(n),
				p = function(a) {
					function b(c) {
						var d = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1];
			...
			"../../component.js": 5,
			"../track-button.js": 36,
			"./off-text-track-menu-item.js": 28,
			"./text-track-menu-item.js": 31
		}],
		31: [function(a, b, c) {
			"use strict";
				...
				o = function(a) {
					...
					return h(b, a), b.prototype.createEl = function() {
						...
						var a = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime(),
							...
							c = n["default"](a, this.player_.duration());
					...
					return h(b, a), b.prototype.createEl = function() {
						...
						if(this.player_.duration()) {
							var a = this.localize("Remaining Time"),
								b = n["default"](this.player_.remainingTime());
		...
		40: [function(a, b, c) {
			...
			var i = a("../utils/fn.js"),
				...
				u = function(a) {
					function b(c) {
						...
						f(this, b), void 0 === e.inline && (e.inline = !0), void 0 === e.vertical && (e.vertical = e.inline ? !1 : !0), e.volumeBar = e.volumeBar || {}, e.volumeBar.vertical = !!e.vertical;
			...
			"../component.js": 5,
			"../popup/popup-button.js": 53,
			"../popup/popup.js": 54,
			"../utils/fn.js": 82,
			"./mute-toggle.js": 11,
			"./volume-control/volume-bar.js": 37
		}],
		41: [function(a, b, c) {
			"use strict";
			...
			n.prototype.options_ = m["default"](k["default"].prototype.options_, {
				fillAlways: !0,
				temporary: !1,
				uncloseable: !0
		...
		46: [function(a, b, c) {
			...
			function e(a) {
				return a instanceof e ? a : ("number" == typeof a ? this.code = a : "string" == typeof a ? this.message = a : "object" === ("undefined" == typeof a ? "undefined" : f(a)) && ("number" == typeof a.code && (this.code = a.code), h["default"](this, a)), void(this.message || (this.message = e.defaultMessages[this.code] || "")))
			}
			c.__esModule = !0;
		...
		47: [function(a, b, c) {
			...
			c.__esModule = !0;
			var i = a("../clickable-component.js"),
				j = e(i),
				k = a("../component.js"),
				l = e(k),
				m = a("./menu.js"),
				...
				u = function(a) {
					...
					return h(b, a), b.prototype.update = function() {
						...
						if(this.options_.title) {
							var b = p.createEl("li", {
								className: "vjs-menu-title",
								innerHTML: t["default"](this.options_.title),
								tabIndex: -1
							});
						...
						this.one(this.menu.contentEl(), "mouseleave", r.bind(this, function() {
			...
			var h = a("../clickable-component.js"),
				...
				n = function(a) {
					...
					return g(b, a), b.prototype.createEl = function(b, c, d) {
						return a.prototype.createEl.call(this, "li", m["default"]({
		...
		51: [function(a, b, c) {
			...
			var i = a("./component.js"),
				...
				u = a("./utils/guid.js"),
				v = d(u),
				w = a("./utils/browser.js"),
				x = d(w),
				y = a("./utils/log.js"),
				z = e(y),
				A = a("./utils/to-title-case.js"),
				B = e(A),
				C = a("./utils/time-ranges.js"),
				D = a("./utils/buffer.js"),
				E = a("./utils/stylesheet.js"),
				F = d(E),
				G = a("./fullscreen-api.js"),
				H = e(G),
				I = a("./media-error.js"),
				J = e(I),
				K = a("safe-json-parse/tuple"),
				L = e(K),
				M = a("object.assign"),
				N = e(M),
				O = a("./utils/merge-options.js"),
				P = e(O),
				Q = a("./tracks/text-track-list-converter.js"),
				R = e(Q),
				S = a("./modal-dialog"),
				T = e(S),
				U = a("./tech/tech.js"),
				V = e(U),
				W = a("./tracks/audio-track-list.js"),
				X = e(W),
				Y = a("./tracks/video-track-list.js"),
				Z = e(Y);
			a("./tech/loader.js"), a("./tech/flash.js"), a("./poster-image.js"), a("./tracks/text-track-display.js"), a("./loading-spinner.js"), a("./big-play-button.js"), a("./close-button.js"), a("./control-bar/control-bar.js"), a("./error-display.js"), a("./tracks/text-track-settings.js"), a("./tech/html5.js");
			var $ = function(a) {
				function b(c, d, e) {
					if(f(this, b), c.id = c.id || "vjs_video_" + v.newGUID(), d = N["default"](b.getTagSettings(c), d), d.initChildren = !1, d.createEl = !1, d.reportTouchActivity = !1, !d.language)
					...
					var k = P["default"](j.options_);
					return d.plugins && ! function() {
						var a = d.plugins;
						Object.getOwnPropertyNames(a).forEach(function(b) {
							"function" == typeof this[b] ? this[b](a[b]) : z["default"].error("Unable to find plugin:", b)
						}, j)
					}(), j.options_.playerOptions = k, j.initChildren(), j.isAudio("audio" === c.nodeName.toLowerCase()), j.addClass(j.controls() ? "vjs-controls-enabled" : "vjs-controls-disabled"), j.el_.setAttribute("role", "region"), j.isAudio() ? j.el_.setAttribute("aria-label", "audio player") : j.el_.setAttribute("aria-label", "video player"), j.isAudio() && j.addClass("vjs-audio"), j.flexNotSupported_() && j.addClass("vjs-no-flex"), x.IS_IOS || j.addClass("vjs-workinghover"), b.players[j.id_] = j, j.userActive(!0), j.reportUserActivity(), j.listenForUserActivity_(), j.on("fullscreenchange", j.handleFullscreenChange_), j.on("stageclick", j.handleStageClick_), j
				}
				return h(b, a), b.prototype.dispose = function() {
					...
					this.removeTechControlsListeners_(), this.on(this.tech_, "mousedown", this.handleTechClick_), this.on(this.tech_, "touchstart", this.handleTechTouchStart_), this.on(this.tech_, "touchmove", this.handleTechTouchMove_), this.on(this.tech_, "touchend", this.handleTechTouchEnd_), this.on(this.tech_, "myTap", this.handleTechTap_)
				}, b.prototype.removeTechControlsListeners_ = function() {
					this.off(this.tech_, "myTap", this.handleTechTap_), this.off(this.tech_, "touchstart", this.handleTechTouchStart_), this.off(this.tech_, "touchmove", this.handleTechTouchMove_), this.off(this.tech_, "touchend", this.handleTechTouchEnd_), this.off(this.tech_, "mousedown", this.handleTechClick_)
					...
					if(this.tech_ && this.tech_.isReady_) try {
						...
						throw void 0 === this.tech_[a] ? z["default"]("Video.js: " + a + " method not defined for " + this.techName_ + " playback technology.", b) : "TypeError" === b.name ? (z["default"]("Video.js: " + a + " unavailable on " + this.techName_ + " playback technology element.", b), this.tech_.isReady_ = !1) : z["default"](b), b
					}
					...
					return c && c.length || (c = C.createTimeRange(0, 0)), c
				}, b.prototype.bufferedPercent = function() {
					return D.bufferedPercent(this.buffered(), this.duration())
					...
					var a = H["default"];
					return this.isFullscreen(!0), a.requestFullscreen ? (p.on(l["default"], a.fullscreenchange, t.bind(this, function b() {
					...
					return this.loadTech_(B["default"](this.options_.techOrder[0]), null), this.techCall_("reset"), this
					...
					return P["default"](b.prototype.options_.languages, this.languages_)
				}, b.prototype.toJSON = function() {
					var a = P["default"](this.options_),
						b = a.tracks;
					a.tracks = [];
					for(var c = 0; c < b.length; c++) {
						var d = b[c];
						d = P["default"](d), d.player = void 0, a.tracks[c] = d
					}
					return a
					...
					if(null !== d) {
						var e = L["default"](d || "{}"),
							f = e[0],
							g = e[1];
						f && z["default"].error(f), N["default"](c, g)
					}
					if(N["default"](b, c), a.hasChildNodes())
			...
			"./error-display.js": 41,
			"./fullscreen-api.js": 44,
			"./loading-spinner.js": 45,
			"./media-error.js": 46,
			"./modal-dialog": 50,
			"./poster-image.js": 55,
			"./tech/flash.js": 59,
			...
			"./tech/loader.js": 61,
			"./tech/tech.js": 62,
			"./tracks/audio-track-list.js": 63,
			"./tracks/text-track-display.js": 68,
			"./tracks/text-track-list-converter.js": 69,
			"./tracks/text-track-settings.js": 71,
			"./tracks/video-track-list.js": 76,
			"./utils/browser.js": 78,
			"./utils/buffer.js": 79,
			"./utils/dom.js": 80,
			"./utils/events.js": 81,
			...
			"./utils/log.js": 85,
			"./utils/merge-options.js": 86,
			"./utils/stylesheet.js": 87,
			"./utils/time-ranges.js": 88,
			"./utils/to-title-case.js": 89,
			"global/document": 92,
			"global/window": 93,
			"object.assign": 136,
			"safe-json-parse/tuple": 145
		}],
		52: [function(a, b, c) {
			"use strict";
			...
			var i = a("../component.js"),
				...
				o = function(a) {
					...
					return h(b, a), b.prototype.createEl = function(b) {
						var c = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
							d = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2];
						return c.className = c.className + " vjs-slider", c = n["default"]({
							tabIndex: 0
						}, c), d = n["default"]({
							role: "slider",
							"aria-valuenow": 0,
		...
		59: [function(a, b, c) {
			...
			c.__esModule = !0;
			for(var k = a("./tech"), l = e(k), m = a("../utils/dom.js"), n = d(m), o = a("../utils/url.js"), p = d(o), q = a("../utils/time-ranges.js"), r = a("./flash-rtmp"), s = e(r), t = a("../component"), u = e(t), v = a("global/window"), w = e(v), x = a("object.assign"), y = e(x), z = w["default"].navigator, A = function(a) {
					function b(c, d) {
						f(this, b);
						var e = g(this, a.call(this, c, d));
					...
					return h(b, a), b.prototype.createEl = function() {
						...
						var a = this.duration();
						return 0 === a ? q.createTimeRange() : q.createTimeRange(0, a)
					}, b.prototype.buffered = function() {
						var a = this.el_.vjs_getProperty("buffered");
						return 0 === a.length ? q.createTimeRange() : q.createTimeRange(a[0][0], a[0][1])
					}, b.prototype.supportsFullScreen = function() {
						return !1
					}, b.prototype.enterFullScreen = function() {
						return !1
					}, b
				}(l["default"]), B = A.prototype, C = "rtmpConnection,rtmpStream,preload,defaultPlaybackRate,playbackRate,autoplay,loop,mediaGroup,controller,controls,volume,muted,defaultMuted".split(","), D = "networkState,readyState,initialTime,startOffsetTime,paused,ended,videoWidth,videoHeight".split(","), E = 0; E < C.length; E++) j(C[E]), i(C[E]);
			for(var F = 0; F < D.length; F++) j(D[F]);
			A.isSupported = function() {
				return A.version()[0] >= 10
			}, l["default"].withSourceHandlers(A), A.nativeSourceHandler = {}, A.nativeSourceHandler.canPlayType = function(a) {
				return a in A.formats ? "maybe" : ""
			}, A.nativeSourceHandler.canHandleSource = function(a) {
				function b(a) {
					var b = p.getFileExtension(a);
					return b ? "video/" + b : ""
				}
				var c = void 0;
				return c = a.type ? a.type.replace(/;.*/, "").toLowerCase() : b(a.src), A.nativeSourceHandler.canPlayType(c)
			}, A.nativeSourceHandler.handleSource = function(a, b) {
				b.setSrc(a.src)
			}, A.nativeSourceHandler.dispose = function() {}, A.registerSourceHandler(A.nativeSourceHandler), A.formats = {
				"video/flv": "FLV",
				"video/x-flv": "FLV",
				"video/mp4": "MP4",
				"video/m4v": "MP4"
				...
				try {
					...
					try {
						z.mimeTypes["application/x-shockwave-flash"].enabledPlugin && (a = (z.plugins["Shockwave Flash 2.0"] || z.plugins["Shockwave Flash"]).description.replace(/\D+/g, ",").match(/^,?(.+),?$/)[1])
					} catch(c) {}
				}
				return a.split(",")
			}, A.embed = function(a, b, c, d) {
				var e = A.getEmbedCode(a, b, c, d),
					f = n.createEl("div", {
						innerHTML: e
					}).childNodes[0];
				return f
			}, A.getEmbedCode = function(a, b, c, d) {
			...
			}, s["default"](A), u["default"].registerComponent("Flash", A), l["default"].registerTech("Flash", A), c["default"] = A
		}, {
			"../component": 5,
			"../utils/dom.js": 80,
			"../utils/time-ranges.js": 88,
		...
		60: [function(a, b, c) {
			...
			var j = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
				...
				F = a("object.assign"),
				G = e(F),
				H = a("../utils/merge-options.js"),
				I = e(H),
				J = a("../utils/to-title-case.js"),
				K = e(J),
				L = function(a) {
					function b(c, d) {
						g(this, b);
						...
						return q.forEach(function(a) {
							...
							if(e["featuresNative" + b + "Tracks"]) {
								var c = e.el()[a + "Tracks"];
								c && c.addEventListener && (c.addEventListener("change", u.bind(e, e["handle" + b + "TrackChange_"])), c.addEventListener("addtrack", u.bind(e, e["handle" + b + "TrackAdd_"])), c.addEventListener("removetrack", u.bind(e, e["handle" + b + "TrackRemove_"])), e.on("loadstart", e["removeOld" + b + "Tracks_"]))
							}
						}), e.featuresNativeTextTracks && (i && w["default"].warn(y["default"](k)), e.handleTextTrackChange_ = u.bind(e, e.handleTextTrackChange), e.handleTextTrackAdd_ = u.bind(e, e.handleTextTrackAdd), e.handleTextTrackRemove_ = u.bind(e, e.handleTextTrackRemove), e.proxyNativeTextTracks_()), (A.TOUCH_ENABLED || A.IS_IPHONE || A.IS_NATIVE_ANDROID) && c.nativeControlsForTouch === !0 && e.setControls(!0), e.triggerReady(), e
					}
					return i(b, a), b.prototype.dispose = function() {
						...
						if(!a || this.movingMediaElementInDOM === !1)
							if(a) {
								...
								var d = this.options_.tag && q.getElAttributes(this.options_.tag),
									e = I["default"]({}, d);
								A.TOUCH_ENABLED && this.options_.nativeControlsForTouch === !0 || delete e.controls, q.setElAttributes(a, G["default"](e, {
						...
						try {
							...
							w["default"](b, "Video is not ready. (Video.js)")
						}
						...
						return b.kind && (c.kind = b.kind), b.label && (c.label = b.label), (b.language || b.srclang) && (c.srclang = b.language || b.srclang), b["default"] && (c["default"] = b["default"]), b.id && (c.id = b.id), b.src && (c.src = b.src), this.el().appendChild(c), this.remoteTextTrackEls().addTrackElement_(c),
			...
			}, L.nativeSourceHandler.canHandleSource = function(a) {
				if(a.type) return L.nativeSourceHandler.canPlayType(a.type);
				if(a.src) {
					var b = s.getFileExtension(a.src);
					return L.nativeSourceHandler.canPlayType("video/" + b)
				}
				return ""
			}, L.nativeSourceHandler.handleSource = function(a, b) {
				b.setSrc(a.src)
			}, L.nativeSourceHandler.dispose = function() {}, L.registerSourceHandler(L.nativeSourceHandler), L.canControlVolume = function() {
				try {
			...
			L.patchCanPlayType = function() {
				A.ANDROID_VERSION >= 4 && (N || (N = L.TEST_VID.constructor.prototype.canPlayType), L.TEST_VID.constructor.prototype.canPlayType = function(a) {
			...
			}, o["default"].registerComponent("Html5", L), m["default"].registerTech("Html5", L), c["default"] = L
		}, {
			"../component": 5,
			"../utils/browser.js": 78,
			"../utils/dom.js": 80,
		...
		62: [function(a, b, c) {
			...
			var j = a("../component"),
				k = e(j),
				l = a("../tracks/html-track-element"),
				m = e(l),
				n = a("../tracks/html-track-element-list"),
				o = e(n),
				p = a("../utils/merge-options.js"),
				q = e(p),
				r = a("../tracks/text-track"),
				s = e(r),
				t = a("../tracks/text-track-list"),
				u = e(t),
				v = a("../tracks/video-track-list"),
				w = e(v),
				x = a("../tracks/audio-track-list"),
				y = e(x),
				z = a("../utils/fn.js"),
				A = d(z),
				B = a("../utils/log.js"),
			...
			"../component": 5,
			"../media-error.js": 46,
			"../tracks/audio-track-list": 63,
			"../tracks/html-track-element": 66,
			"../tracks/html-track-element-list": 65,
			"../tracks/text-track": 72,
			"../tracks/text-track-list": 70,
			"../tracks/video-track-list": 76,
			"../utils/buffer.js": 79,
			"../utils/fn.js": 82,
			"../utils/log.js": 85,
			"../utils/merge-options.js": 86,
		...
		66: [function(a, b, c) {
			...
			c.__esModule = !0;
			var i = a("../utils/browser.js"),
				j = e(i),
				k = a("global/document"),
				l = d(k),
				m = a("../event-target"),
				n = d(m),
				o = a("../tracks/text-track"),
				p = d(o),
				q = 0,
				r = 1,
				s = 2,
		...
		71: [function(a, b, c) {
			...
			var l = a("../component"),
				...
				x = function(a) {
					function b(c, d) {
						f(this, b);
						var e = g(this, a.call(this, c, d));
						return e.hide(), void 0 === d.persistTextTrackSettings && (e.options_.persistTextTrackSettings = e.options_.playerOptions.persistTextTrackSettings), o.on(e.$(".vjs-done-button"), "click", q.bind(e, function() {
							this.saveSettings(), this.hide()
						})), o.on(e.$(".vjs-default-button"), "click", q.bind(e, function() {
						...
						})), o.on(e.$(".vjs-fg-color > select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-bg-color > select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".window-color > select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-text-opacity > select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-bg-opacity > select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-window-opacity > select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-font-percent select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-edge-style select"), "change", q.bind(e, e.updateDisplay)), o.on(e.$(".vjs-font-family select"), "change", q.bind(e, e.updateDisplay)), e.options_.persistTextTrackSettings && e.restoreSettings(), e
					}
					return h(b, a), b.prototype.createEl = function() {
						var b = this.id_,
						...
						var a = j(this.$(".vjs-edge-style select")),
							b = j(this.$(".vjs-font-family select")),
							c = j(this.$(".vjs-fg-color > select")),
							d = j(this.$(".vjs-text-opacity > select")),
							e = j(this.$(".vjs-bg-color > select")),
							f = j(this.$(".vjs-bg-opacity > select")),
							g = j(this.$(".window-color > select")),
							h = j(this.$(".vjs-window-opacity > select")),
							i = w["default"].parseFloat(j(this.$(".vjs-font-percent > select"))),
							k = {
								fontPercent: i,
								fontFamily: b,
								textOpacity: d,
						...
						k(this.$(".vjs-edge-style select"), a.edgeStyle), k(this.$(".vjs-font-family select"), a.fontFamily), k(this.$(".vjs-fg-color > select"), a.color), k(this.$(".vjs-text-opacity > select"), a.textOpacity), k(this.$(".vjs-bg-color > select"), a.backgroundColor), k(this.$(".vjs-bg-opacity > select"), a.backgroundOpacity), k(this.$(".window-color > select"), a.windowColor), k(this.$(".vjs-window-opacity > select"), a.windowOpacity);
						var b = a.fontPercent;
						b && (b = b.toFixed(2)), k(this.$(".vjs-font-percent > select"), b)
					}, b.prototype.restoreSettings = function() {
						var a = void 0,
							b = void 0;
						try {
							var c = u["default"](w["default"].localStorage.getItem("vjs-text-track-settings"));
							a = c[0], b = c[1], a && s["default"].error(a)
						} catch(d) {
							s["default"].warn(d)
						}
						b && this.setValues(b)
						...
						if(this.options_.persistTextTrackSettings) {
							...
							try {
								Object.getOwnPropertyNames(a).length > 0 ? w["default"].localStorage.setItem("vjs-text-track-settings", JSON.stringify(a)) : w["default"].localStorage.removeItem("vjs-text-track-settings")
							} catch(b) {
								s["default"].warn(b)
							}
						}
			...
			m["default"].registerComponent("TextTrackSettings", x), c["default"] = x
		}, {
			"../component": 5,
			"../utils/events.js": 81,
			"../utils/fn.js": 82,
			...
			var i = a("./text-track-cue-list"),
				...
				B = function(a, b) {
					var c = {
						...
						d = t.isCrossOrigin(a);
					d && (c.cors = d), v["default"](c, l.bind(this, function(a, c, d) {
		...
		80: [function(a, b, c) {
			...
			function j(a) {
				return !!a && "object" === ("undefined" == typeof a ? "undefined" : H(a)) && 1 === a.nodeType
			}

			function k(a) {
				return function(b, c) {
					if(!g(b)) return K["default"][a](null);
					g(c) && (c = K["default"].querySelector(c));
					var d = j(c) ? c : K["default"];
					return d[a] && d[a](b)
				}
			}

			function l(a) {
				return 0 === a.indexOf("#") && (a = a.slice(1)), K["default"].getElementById(a)
			}
			...
			function m() {
				var a = arguments.length <= 0 || void 0 === arguments[0] ? "div" : arguments[0],
					b = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
					c = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2],
					d = K["default"].createElement(a);
				return Object.getOwnPropertyNames(b).forEach(function(a) {
					var c = b[a]; - 1 !== a.indexOf("aria-") || "role" === a || "type" === a ? (Q["default"].warn(S["default"](I, a, c)), d.setAttribute(a, c)) : d[a] = c
			...
			function p(a) {
				var b = a[U];
				return b || (b = a[U] = O.newGUID()), T[b] || (T[b] = {}), T[b]
			}

			function q(a) {
				var b = a[U];
				return b ? !!Object.getOwnPropertyNames(T[b]).length : !1
			}
			...
			function r(a) {
				...
				if(b) {
					...
					try {
						...
						a.removeAttribute ? a.removeAttribute(U) : a[U] = null
					}
				}
			}
			...
			function A(a) {
				...
				var c = K["default"].documentElement,
					d = K["default"].body,
					e = c.clientLeft || d.clientLeft || 0,
					f = M["default"].pageXOffset || d.scrollLeft,
					g = b.left + f - e,
					h = c.clientTop || d.clientTop || 0,
					i = M["default"].pageYOffset || d.scrollTop,
					j = b.top + i - h;
				return {
					left: Math.round(g),
					top: Math.round(j)
			...
			function C(a) {
				return !!a && "object" === ("undefined" == typeof a ? "undefined" : H(a)) && 3 === a.nodeType
			}
			...
			function E(a) {
				return "function" == typeof a && (a = a()), (Array.isArray(a) ? a : [a]).map(function(a) {
					return "function" == typeof a && (a = a()), j(a) || C(a) ? a : "string" == typeof a && /\S/.test(a) ? K["default"].createTextNode(a) : void 0
				}).filter(function(a) {
					return a
				})
			}
			...
			var H = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
				...
				I = f(["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."], ["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."]);
			...
			var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
				...
				j = c.logByType = function(a, b) {
					var c = arguments.length <= 2 || void 0 === arguments[2] ? !!h.IE_VERSION && h.IE_VERSION < 11 : arguments[2],
						d = g["default"].console && g["default"].console[a] || function() {};
					"log" !== a && b.unshift(a.toUpperCase() + ":"), i.history.push(b), b.unshift("VIDEOJS:"), c && (b = b.map(function(a) {
						...
						return String(a)
					}).join(" ")), d.apply ? d[Array.isArray(b) ? "apply" : "call"](console, b) : d(b)
				};
			i = function() {
		...
		86: [function(a, b, c) {
			...
			function g() {
				...
				return a.unshift({}), a.push(f), j["default"].apply(null, a), a[0]
			}
			c.__esModule = !0;
			var h = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
				return typeof a
			...
			c["default"] = g;
			var i = a("lodash-compat/object/merge"),
				j = d(i)
		}, {
			"lodash-compat/object/merge": 131
		}],
		87: [function(a, b, c) {
			"use strict";
		...
		91: [function(b, c, d) {
			...
			function g(a, b, c) {
				...
				return d.player || x["default"].players[d.playerId] || new x["default"](d, b, c)
			}
			d.__esModule = !0;
			var h = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
					return typeof a
				...
				y = b("./plugins.js"),
				z = f(y),
				A = b("./utils/merge-options.js"),
				B = f(A),
				C = b("./utils/fn.js"),
				D = e(C),
				E = b("./tracks/text-track.js"),
				F = f(E),
				G = b("./tracks/audio-track.js"),
				H = f(G),
				I = b("./tracks/video-track.js"),
				J = f(I),
				K = b("./utils/time-ranges.js"),
				...
				_ = b("./tech/tech.js"),
				aa = f(_);
			if("undefined" == typeof HTMLVideoElement && (l["default"].createElement("video"), l["default"].createElement("audio"), l["default"].createElement("track")), j["default"].VIDEOJS_NO_DYNAMIC_STYLE !== !0) {
				var ba = Q.$(".vjs-styles-defaults");
				if(!ba) {
					ba = p.createStyleElement("vjs-styles-defaults");
					var ca = Q.$("head");
					ca && ca.insertBefore(ba, ca.firstChild), p.setTextContent(ba, "\n      .video-js {\n        width: 300px;\n        height: 150px;\n      }\n\n      .vjs-fluid {\n        padding-top: 56.25%\n      }\n    ")
				}
			}
			n.autoSetupTimeout(1, g), g.VERSION = "5.12.1", g.options = x["default"].prototype.options_, g.getPlayers = function() {
				...
				aa["default"].isTech(b) && O["default"].warn("The " + a + " tech was registered as a component. It should instead be registered using videojs.registerTech(name, tech)"), r["default"].registerComponent.call(r["default"], a, b)
			}, g.getTech = aa["default"].getTech, g.registerTech = aa["default"].registerTech, g.browser = S, g.TOUCH_ENABLED = S.TOUCH_ENABLED, g.extend = W["default"], g.mergeOptions = B["default"], g.bind = D.bind, g.plugin = z["default"], g.addLanguage = function(a, b) {
				var c;
			...
			"./setup": 56,
			"./tech/tech.js": 62,
			"./tracks/audio-track.js": 64,
			"./tracks/text-track.js": 72,
			"./tracks/video-track.js": 77,
			"./utils/browser.js": 78,
			"./utils/dom.js": 80,
			"./utils/events.js": 81,
			"./utils/fn.js": 82,
		...
		105: [function(a, b) {
			...
			"../lang/isArguments": 120,
			"../lang/isArray": 121,
			"../lang/isPlainObject": 125,
			"../lang/isTypedArray": 127,
			"../lang/toPlainObject": 128,
			"./arrayCopy": 99,
			"./isArrayLike": 112
		}],
		106: [function(a, b) {
		...
		120: [function(a, b) {
			...
			"../internal/isArrayLike": 112,
			"../internal/isObjectLike": 117
		}],
		121: [function(a, b) {
			var c = a("../internal/getNative"),
		...
		130: [function(a, b) {
			...
			"../internal/arrayEach": 100,
			"../internal/isIndex": 114,
			"../internal/isLength": 116,
			"../lang/isArguments": 120,
			"../lang/isArray": 121,
			"../lang/isFunction": 122,
		...
		131: [function(a, b) {
			...
			"../internal/baseMerge": 104,
			"../internal/createAssigner": 108
		}],
		132: [function(a, b) {
				...
				if(e(a, function(a, c) {
						switch(a) {
							...
							case "viewportanchor":
								...
								var f = new d;
								if(f.percent("x", e[0]),
									f.percent("y", e[1]), !f.has("x") || !f.has("y")) break;
